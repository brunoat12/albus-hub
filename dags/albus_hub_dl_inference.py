...
def albus_hub_dl_inference():
    ...
    def run_risk_inference(
        ...
        return run_project_script("scripts/run_risk_inference.py")
    ...
    inference = run_risk_inference(validation)

    validation_result = validate_risk_scores(inference)

    alerts = publish_risk_alerts(inference)
